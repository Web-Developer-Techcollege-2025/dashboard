import { fetchDRNews } from "../data/DRNewsAPI.js";
import { create } from "../utils/create.js";
import { set } from "../utils/set.js";

export async function DRNewsModule() {
  const drNewsContainer = create("section", "dr-news-container");
  ...
  try {
    ...
    for (let i = 0; i < 3; i++) {
      ...
      let category = [
        ...
        "Underholdning",
        "Videnskab",
      ]; //Random category generator for news items, replace with the below
